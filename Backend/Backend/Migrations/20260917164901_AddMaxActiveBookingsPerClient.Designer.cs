...
namespace Backend.Migrations
{
    ...
    [Migration("20260917164901_AddMaxActiveBookingsPerClient")]
    partial class AddMaxActiveBookingsPerClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.BarbershopOwner", b =>
                {
                    ...
                    b.Property<int>("MaxActiveBookingsPerClient")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Models.PromoKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Models.PromoKey", b =>
                {
                    b.HasOne("Backend.Models.BarbershopOwner", "UsedByOwner")
                        .WithMany()
                        .HasForeignKey("UsedByOwnerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("UsedByOwner");
                });
